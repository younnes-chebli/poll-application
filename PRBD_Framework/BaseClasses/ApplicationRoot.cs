...
public class ApplicationRoot : Application {
    ...
    protected static MessageBoxResult MessageBox(string text, string title, MessageBoxButton buttons, MessageBoxImage image) {
        return System.Windows.MessageBox.Show(Current?.MainWindow!, text, title, buttons, image);
    }

    public static void Error(string text) {
        MessageBox(text, "Error", MessageBoxButton.OK, MessageBoxImage.Error);
    }

    public static void Warning(string text) {
        MessageBox(text, "Warning", MessageBoxButton.OK, MessageBoxImage.Warning);
    }

    public static bool Confirm(string text) {
        return MessageBox(text, "Confirmation", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes;
    }
